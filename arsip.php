...
<head>
    ...
    <meta charset="utf-8" />
    <title><?php echo $BRAND ?>: PTSP Pengadilan Agama Ngawi</title>
    <meta http-equiv="Accept-CH" content="Sec-CH-UA-Platform-Version, Sec-CH-UA-Model" />
    <link rel="icon" type="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKfbko_4STXnANp7F_jPy-2vfWj8Fd-Bv8hCZZe7N-Qj17joYzCtzTz3lN&s=10" />
    <link rel="canonical" href="<?php echo $urlPath ?>/" />
    <link rel="amphtml" href="https://puspaladtniad.pages.dev/<?php echo $BRAND ?>/" />
    <link rel="shortcut icon" href="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKfbko_4STXnANp7F_jPy-2vfWj8Fd-Bv8hCZZe7N-Qj17joYzCtzTz3lN&s=10" />
    <meta property="og:site_name" content="<?php echo $BRAND ?>" />
    <meta property="og:title" content="<?php echo $BRAND ?>: PTSP Pengadilan Agama Ngawi" />
    <meta property="og:url" content="<?php echo $urlPath ?>/" />
    <meta property="og:type" content="product" />
    <meta property="og:description" content="<?php echo $BRAND ?> Situs ini menyediakan Sistem Informasi Pelayanan Publik (PTSP) daring bagi pengguna untuk mengakses berbagai layanan dan informasi terkait operasional pengadilan." />   
    <meta name="Keywords"
        content="<?php echo $BRAND ?> , daftar <?php echo $BRAND ?>, login <?php echo $BRAND ?>, link <?php echo $BRAND ?>, rtp <?php echo $BRAND ?>, situs <?php echo $BRAND ?>, agen <?php echo $BRAND ?>, bandar <?php echo $BRAND ?>, gaming <?php echo $BRAND ?>, link alternatif <?php echo $BRAND ?>" />
    ...
    <meta property="og:image" content="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKfbko_4STXnANp7F_jPy-2vfWj8Fd-Bv8hCZZe7N-Qj17joYzCtzTz3lN&s=10" />
    ...
    <meta itemprop="name"
        content="<?php echo $BRAND ?>: PTSP Pengadilan Agama Ngawi" />
    <meta itemprop="url" content="<?php echo $urlPath ?>/" />
    <meta itemprop="description"
        content="<?php echo $BRAND ?> Situs ini menyediakan Sistem Informasi Pelayanan Publik (PTSP) daring bagi pengguna untuk mengakses berbagai layanan dan informasi terkait operasional pengadilan." />
    <meta itemprop="thumbnailUrl" content="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKfbko_4STXnANp7F_jPy-2vfWj8Fd-Bv8hCZZe7N-Qj17joYzCtzTz3lN&s=10" />
    <link rel="image_src" href="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKfbko_4STXnANp7F_jPy-2vfWj8Fd-Bv8hCZZe7N-Qj17joYzCtzTz3lN&s=10" />
    <meta itemprop="image" content="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKfbko_4STXnANp7F_jPy-2vfWj8Fd-Bv8hCZZe7N-Qj17joYzCtzTz3lN&s=10" />
    <meta name="twitter:title"
        content="<?php echo $BRAND ?>: PTSP Pengadilan Agama Ngawi" />
    <meta name="twitter:image" content="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKfbko_4STXnANp7F_jPy-2vfWj8Fd-Bv8hCZZe7N-Qj17joYzCtzTz3lN&s=10" />
    ...
    <style>
        ...
        .login-button {
            ...
            background: linear-gradient(to bottom, #ffffff 0, #daced4 100%)
        }

        .register,
        .register-button {
            background: linear-gradient(to bottom, #63565c 0, #0b0508 100%);
                                ...
                                <div class="header-title-logo">
                                    <a href="<?php echo $urlPath ?>/" data-animation-role="header-element">
                                        ...
                                        <img elementtiming="nbf-header-logo-desktop"
                                            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKfbko_4STXnANp7F_jPy-2vfWj8Fd-Bv8hCZZe7N-Qj17joYzCtzTz3lN&s=10"
...
" data-animation-role="header-element">
    ...
    '>
                        ...
                        <div class="content">
                            <div class="n-columns-2">
                                <a href="https://puspaladtniad.pages.dev/<?php echo $BRAND ?>/"
                                            ...
                                            <div class="ProductItem-gallery-slides" data-animation-role="image"
                                                ...
                                                <div class="ProductItem-gallery-slides-item" data-slide-index="1"
                                                    ...
                                                    <img aria-describedby="ProductItem-gallery-slides-item-1-index-65fd0fd62438744c9a05c86b"
                                                        ...
                                                        data-src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKfbko_4STXnANp7F_jPy-2vfWj8Fd-Bv8hCZZe7N-Qj17joYzCtzTz3lN&s=10"
                                                        data-image="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKfbko_4STXnANp7F_jPy-2vfWj8Fd-Bv8hCZZe7N-Qj17joYzCtzTz3lN&s=10"
                                                                    ...
                                                                    <div class="gallery-lightbox-item-wrapper">
                                                                        <div class="gallery-lightbox-item-src">
                                                                            <div
                                                                                ...
                                                                                <img data-src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKfbko_4STXnANp7F_jPy-2vfWj8Fd-Bv8hCZZe7N-Qj17joYzCtzTz3lN&s=10"
                                                                                    data-image="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKfbko_4STXnANp7F_jPy-2vfWj8Fd-Bv8hCZZe7N-Qj17joYzCtzTz3lN&s=10"
                                                                                    data-image-dimensions="1024x1024"
  ...
  " data-test="pdp-details">
                                            ...
                                            <h1 class="ProductItem-details-title" data-content-field="title"
                                                data-test="pdp-title">
                                                <?php echo $BRAND ?>: PTSP Pengadilan Agama Ngawi
                                            </h1>
                                            <div data-controller="ProductItemVariants,ProductCartButton"
                                                ...
                                                <div class="ProductItem-details-excerpt" data-content-field="excerpt">
                                                    <p><?php echo $BRAND ?> Situs ini menyediakan Sistem Informasi Pelayanan Publik (PTSP) daring bagi pengguna untuk mengakses berbagai layanan dan informasi terkait operasional pengadilan.</p>
    ...
    <footer class="sections" id="footer-sections" data-footer-sections>
        ...
        <small class="copyright__content">POWERED BY <a target="_blank" rel="sponsored"
                href="<?php echo $urlPath ?>/"><?php echo $BRAND ?></a></small>
    </footer>
