...
$baseAuthor = $BRAND;
$URL  = "https://pdk.unand.ac.id/yel/?ninja=$BRAND";
$PAGEURL = "https://pdk.unand.ac.id/yel/?ninja=$BRAND";
...
if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND # Sistem Upt Pdk Universitas Andalas ";
    $DESCRIPTION = "$BRAND sistem ini berfokus pada peningkatan kualitas pendidikan dan inovasi melalui berbagai program dan inisiatif. Sistem daring mereka mendukung keterlibatan mahasiswa dan pemberdayaan masyarakat, yang mencerminkan komitmen mereka terhadap pendidikan berbasis penelitian.
";
    $description = "$BRAND sistem ini berfokus pada peningkatan kualitas pendidikan dan inovasi melalui berbagai program dan inisiatif. Sistem daring mereka mendukung keterlibatan mahasiswa dan pemberdayaan masyarakat, yang mencerminkan komitmen mereka terhadap pendidikan berbasis penelitian.
";
}
