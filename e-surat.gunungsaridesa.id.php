...
$baseAuthor = $BRAND;
$URL  = "https://e-surat.gunungsaridesa.id/?ninja=$BRAND";
$PAGEURL = "https://e-surat.gunungsaridesa.id/?ninja=$BRAND";
$AMP = "https://stifarriau-info.pages.dev/$BRAND";
$DAFTAR = "https://stifarriau-info.pages.dev/";
...
if ($NUMLIST >= 1 && $NUMLIST <= 31134) {
    $TITLE = "$BRAND # E-Surat Desa Gunungsari ";
    $DESCRIPTION = "$BRAND adalah platform yang digunakan untuk pengelolaan surat elektronik di tingkat desa, memudahkan proses administrasi dan komunikasi.
";
    $description = "$BRAND adalah platform yang digunakan untuk pengelolaan surat elektronik di tingkat desa, memudahkan proses administrasi dan komunikasi.
";
}
